...
- [x] **FOUND-03**: Touch input chuẩn (không scroll trang, pointerdown events, touch-action: none)
...
- [x] **FLOW-03**: 5 trạng thái nhìn là phân biệt được ngay, không cần đọc text
