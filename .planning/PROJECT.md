...
- [ ] **HUD-03 fix:** comboLabel hiển thị multiplier.toFixed(1) từ đầu ván (hiện đang hiển thị tapCount, ẩn khi streak ≤ 1)
- [ ] **JuiceHelpers coupling:** refactor GameController để dùng getUrgencyStage() và getMilestoneLabel() thay vì inline logic
- [ ] Sound effects: tap đúng, tap sai, combo milestone, phase transition, game over
- [ ] Phase transition visual cue khi bước vào Phase 2 (40s) và Phase 3 (80s)
- [ ] Results screen score count-up animation
- [ ] Screen shake khi tap sai
